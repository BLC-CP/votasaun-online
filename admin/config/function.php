...
function mfa_mq($aksaun){
	global $conn;

	return $mfa_mq = mysqli_fetch_array(mysqli_query($conn, $aksaun));
}
...
function uploadFotos(){
	...
	move_uploaded_file($tmpName, 'imgkandidatu/' . $nrnFoun);
	return $nrnFoun;
}
...
function uploadFoto(){
	...
	move_uploaded_file($tmpName, 'imgestudante/' . $nrnFoun);
	return $nrnFoun;
}
// end upload imagen estudante
